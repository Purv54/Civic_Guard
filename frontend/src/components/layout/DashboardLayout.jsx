...
const DashboardLayout = () => {
    ...
    return (
        <div className="flex flex-1 w-full bg-slate-50 relative items-stretch">
            {/* Sidebar */}
            <div className="hidden lg:block w-72 shrink-0 bg-primary">
                <aside className="flex flex-col w-72 text-white sticky top-[74px] h-[calc(100vh-74px)] z-30">
                    <div className="p-8">
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-slate-50/50">
                {/* Header */}
                <header className="h-20 bg-white border-b border-slate-200 shadow-sm flex items-center justify-between px-8 z-20 shrink-0">
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <div className="flex items-center space-x-4 pl-6 border-l border-slate-100">
                            ...
                            <button
                                ...
                                title="My Profile"
                                className="w-10 h-10 rounded-full bg-primary/10 hover:bg-accent/20 flex items-center justify-center text-primary font-bold border-2 border-primary/20 hover:border-accent transition-all cursor-pointer"
                            >
                                {user?.first_name
